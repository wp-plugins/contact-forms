...
wpWidgets = {
    ...
    init : function() {
        ...
        //Apertura/chiusura aree nella colonna destra (ce n'è solo una in questo caso!)
        $('#widgets-right').children('.widgets-holder-wrap').children('.sidebar-name').click(function(){
            var t = $(this);
            var c = t.siblings('.widgets-sortables'), p = t.parent();
        ...
        //Apertura/chiusura aree nella colonna sinistra (ce n'è solo una in questo caso!)
